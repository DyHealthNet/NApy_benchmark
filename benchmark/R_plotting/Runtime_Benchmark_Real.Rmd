...
runtimes_CHRIS_sum$label <- paste0("NApy x ", round(runtimes_CHRIS_sum$fold_change_comp_napy, 2))

runtimes_CHRIS_sum$label[runtimes_CHRIS_sum$method == "Pearson" & runtimes_CHRIS_sum$threads == 1] <- paste0("pandas x ", round(runtimes_CHRIS_sum$fold_change_napy_comp[runtimes_CHRIS_sum$method == "Pearson" & runtimes_CHRIS_sum$threads == 1], 2))
